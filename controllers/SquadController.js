...
exports.createSquad = async (req, res) => {
  try {
    ...
    console.log(`Incoming CREATE Request for Squad`);
    console.log(`Request from User: ${userId}`);
    console.log("Squad Data:", req.body);
...
exports.getSquads = async (req, res) => {
  try {
    const userId = req.userId;
    console.log(`Incoming GET Request for Squads from User: ${userId}`);
...
exports.getSquadById = async (req, res) => {
  try {
    ...
    console.log(`Incoming GET Request for Squad ID: ${squadId}`);
...
exports.updateSquad = async (req, res) => {
  try {
    const userId = req.userId;
    const squadId = req.params.id;
    console.log(`Incoming UPDATE Request for Squad ID: ${squadId}`);
...
exports.deleteSquad = async (req, res) => {
  try {
    const userId = req.userId;
    const squadId = req.params.id;
    console.log(`Incoming DELETE Request for Squad ID: ${squadId}`);
    ...
    console.log("Squad Deleted:", squad);
