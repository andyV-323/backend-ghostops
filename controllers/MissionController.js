...
exports.createMission = async (req, res) => {
  try {
    ...
    console.log(`Incoming CREATE Request for Mission`);
...
exports.getMissions = async (req, res) => {
  try {
    const userId = req.userId;
    console.log(`Incoming GET Request for Missions from User: ${userId}`);
...
exports.updateMission = async (req, res) => {
  try {
    const userId = req.userId;
    const missionId = req.params.id;
    console.log(`Incoming UPDATE Request for Mission ID: ${missionId}`);
...
exports.deleteMission = async (req, res) => {
  try {
    const userId = req.userId;
    const missionId = req.params.id;
    console.log(`Incoming DELETE Request for Mission ID: ${missionId}`);
    ...
    console.log("Mission Deleted:", deletedMission);
